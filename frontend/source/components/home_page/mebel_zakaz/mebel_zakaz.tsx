    ...
    <main>
      <div className={s.mebel_zakaz_container}>
        ...
        <span className={s.mebel_zakaz_text2}>
          Дизайнерські меблі на кухню, у передпокій, вітальню та спальню.
          Підкресліть індивідуальність інтер’єру за допомогою меблів на
          замовлення від виробника Chukin•m
        </span>
